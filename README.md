...
* (*Arxiv'25*) \[2508] [![Stargazers](https://img.shields.io/github/stars/InternLM/InternBootcamp?style=social)](https://github.com/InternLM/InternBootcamp) ⭐ 350 | 🐛 4 | 🌐 Python | 📅 2026-08-12 [InternBootcamp Technical Report: Boosting LLM Reasoning with Verifiable Task Scaling (Shanghai AI Laboratory, Fudan University)](https://arxiv.org/pdf/2508.08636) - Advanced reasoning through structured thinking processes

* (*Arxiv'25*) \[2505] [![Stargazers](https://img.shields.io/github/stars/MiniMax-AI/SynLogic?style=social)](https://github.com/MiniMax-AI/SynLogic) ⭐ 206 | 🐛 1 | 🌐 Python | 📅 2025-07-07 [SynLogic: Synthesizing Verifiable Reasoning Data at Scale for Learning Logical Reasoning and Beyond (The Hong Kong University of Science and Technology, MiniMax, The City University of Hong Kong)](https://arxiv.org/abs/2505.19641) - Systematic approach to generating logical reasoning data
...
* (*ICLR'25*) \[2408] [![Stargazers](https://img.shields.io/github/stars/sentient-engineering/agent-q?style=social)](https://github.com/sentient-engineering/agent-q) ⭐ 509 | 🐛 7 | 🌐 Python | 📅 2024-09-26 [Agent Q: Advanced Reasoning and Learning for Autonomous AI Agents (The AGI Company (MultiOn), Stanford University)](https://arxiv.org/pdf/2408.07199) - Combination of DPO, MCTS, and process supervision for web navigation tasks with multi-modal reasoning rewards
...
* (*Arxiv'25*) \[2508] [![Stargazers](https://img.shields.io/github/stars/SkyworkAI/Matrix-Game?style=social)](https://github.com/SkyworkAI/Matrix-Game) ⭐ 2,299 | 🐛 32 | 🌐 Python | 📅 2026-03-30 [Matrix-Game 2.0: An Open-Source, Real-Time, andStreaming Interactive World Model (Skywork AI)](https://arxiv.org/pdf/2508.13009) - Matrix-Game 2.0 for real-time interactive video generation
...
* (*Arxiv'24*) \[2412] [![Stargazers](https://img.shields.io/github/stars/TheAgentCompany/TheAgentCompany?style=social)](https://github.com/TheAgentCompany/TheAgentCompany) ⭐ 764 | 🐛 25 | 🌐 Python | 📅 2025-11-17 [TheAgentCompany: Benchmarking LLM Agents on Consequential Real World Tasks (Carnegie Mellon University, Duke University)](https://arxiv.org/abs/2412.14161) - A benchmark for evaluating LLM agents on real-world professional tasks.

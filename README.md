...
* (*Arxiv'25*) \[2508] [![Stargazers](https://img.shields.io/github/stars/InternLM/InternBootcamp?style=social)](https://github.com/InternLM/InternBootcamp) ⭐ 351 | 🐛 3 | 🌐 Python | 📅 2026-08-12 [InternBootcamp Technical Report: Boosting LLM Reasoning with Verifiable Task Scaling (Shanghai AI Laboratory, Fudan University)](https://arxiv.org/pdf/2508.08636) - Advanced reasoning through structured thinking processes
...
* (*Arxiv'25*) \[2508] [![Stargazers](https://img.shields.io/github/stars/SkyworkAI/Matrix-Game?style=social)](https://github.com/SkyworkAI/Matrix-Game) ⭐ 2,329 | 🐛 35 | 🌐 Python | 📅 2026-03-30 [Matrix-Game 2.0: An Open-Source, Real-Time, andStreaming Interactive World Model (Skywork AI)](https://arxiv.org/pdf/2508.13009) - Matrix-Game 2.0 for real-time interactive video generation
...
* (*Arxiv'25*) \[2505] [![Stargazers](https://img.shields.io/github/stars/PRIME-RL/Entropy-Mechanism-of-RL?style=social)](https://github.com/PRIME-RL/Entropy-Mechanism-of-RL) ⭐ 451 | 🐛 2 | 🌐 Python | 📅 2025-07-11 [The Entropy Mechanism of Reinforcement Learning for Reasoning Language Models (Shanghai AI Laboratory, Tsinghua University, UIUC, Peking University, Nanjing University, CUHK)](https://arxiv.org/abs/2505.22617) - Understanding how entropy affects reinforcement learning in reasoning models, it indicated that the improvement of self-train may cause by the entropy mechanism.

* (*Arxiv'25*) \[2505] [![Stargazers](https://img.shields.io/github/stars/sunblaze-ucb/Intuitor?style=social)](https://github.com/sunblaze-ucb/Intuitor) ⭐ 421 | 🐛 14 | 🌐 Python | 📅 2026-01-26 [Maximizing Confidence Alone Improves Reasoning (Carnegie Mellon University)](https://arxiv.org/abs/2505.22660) - The paper introduces RENT, a fully unsupervised reinforcement learning method that uses a model's entropy as an intrinsic reward to improve reasoning by reinforcing chains of thought with high model confidence, eliminating the need for external rewards or ground-truth answers.

* (*Arxiv'25*) \[2505] [![Stargazers](https://img.shields.io/github/stars/sunblaze-ucb/Intuitor?style=social)](https://github.com/sunblaze-ucb/Intuitor) ⭐ 421 | 🐛 14 | 🌐 Python | 📅 2026-01-26 [Learning to Reason without External Rewards (UC Berkeley, Yale University)](https://arxiv.org/abs/2505.19590) - The paper introduces Intuitor, a method that uses a model's self-certainty as an intrinsic reward signal for unsupervised reinforcement learning, enabling effective reasoning and generalization without external rewards.

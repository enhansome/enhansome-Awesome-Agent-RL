...
* (*Arxiv'25*) \[2508] [![Stargazers](https://img.shields.io/github/stars/SkyworkAI/Matrix-Game?style=social)](https://github.com/SkyworkAI/Matrix-Game) ⭐ 2,316 | 🐛 34 | 🌐 Python | 📅 2026-03-30 [Matrix-Game 2.0: An Open-Source, Real-Time, andStreaming Interactive World Model (Skywork AI)](https://arxiv.org/pdf/2508.13009) - Matrix-Game 2.0 for real-time interactive video generation
...
* (*Arxiv'25*) \[2506] [![Stargazers](https://img.shields.io/github/stars/ruixin31/Spurious_Rewards?style=social)](https://github.com/ruixin31/Spurious_Rewards) ⭐ 363 | 🐛 5 | 🌐 Python | 📅 2025-07-29 [Spurious Rewards: Rethinking Training Signals in RLVR (University of Washington, Allen Institute for Artificial Intelligence, University of California, Berkeley)](https://arxiv.org/abs/2506.10947) - Can random reward improve model performance?
